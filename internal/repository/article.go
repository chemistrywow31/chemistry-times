...
func (r *ArticleRepository) Update(ctx context.Context, id primitive.ObjectID, update bson.M) error {
...
func (r *ArticleRepository) List(ctx context.Context, page, limit int) (*model.ArticleListResponse, error) {
	if page < 1 {
		page = 1
	}
	if limit < 1 || limit > 50 {

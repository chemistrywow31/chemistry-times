...
腳本會自動產生 timestamp tag（例如 `20260401-083000`）。

#### Step 2：在 Production Server 部署

```bash
# 設定 registry 和 tag
export REGISTRY=your-registry.example.com
export IMAGE_TAG=20260401-083000
...
```bash
# 確認服務啟動
curl http://your-server:17171/chemistry-times/api/articles?page=1&limit=1

# 確認頁面可存取
curl -I http://your-server:17171/chemistry-times
```
...
The script generates a timestamp tag automatically (e.g., `20260401-083000`).
